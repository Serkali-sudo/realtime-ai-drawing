package com.serhat.realtimeaidrawing.app;
...
public class ApplicationPath {
    ...
    public static String savePath() {
        return getQuantumPath("AI Drawing Saved", Environment.DIRECTORY_PICTURES);
    }

    public static String upscalePath() {
        return getQuantumPath("AI Drawing Upscaled", Environment.DIRECTORY_PICTURES);
    }
